...
| 技能名称 | 版本 | 用途 | 分配给 |
|---------|------|------|--------|
| **github** | 1.0.0 | 代码托管、PR管理、Issues追踪 | Engineer, Reviewer |
| **ddg-web-search** | 1.0.0 | DuckDuckGo 网页搜索、实时信息获取 | Analyst, Mentor |
| **summarize** | 1.0.0 | 文本/文档自动总结 | Mentor, Analyst |
| **markdown-fetch** | 1.0.0 | 网页内容提取（Markdown格式） | Analyst, Mentor |
| **notion** | 1.0.0 | Notion 笔记/数据库操作 | Engineer, Mentor |
| **obsidian** | 1.0.0 | Obsidian 知识库管理 | Mentor |
| **weather** | 1.0.0 | 天气查询 | Analyst（影响分析） |
| **apple-notes** | 1.0.0 | Apple Notes 同步 | Mentor |
| **apple-reminders** | 1.0.0 | Apple 提醒事项 | Mentor（任务追踪） |
| **1password** | 1.0.1 | 密码管理（安全） | Engineer（密钥管理） |
| **trello** | 1.0.0 | 看板任务管理 | Engineer（项目管理） |
...
| Agent | 安装前 | 安装后 | 提升率 |
|-------|--------|--------|--------|
| Engineer | 0 skills | 5 skills | 🚀 +500% |
| Analyst | 0 skills | 4 skills | 🚀 +400% |
| Mentor | 0 skills | 7 skills | 🚀 +700% |
| Reviewer | 0 skills | 2 skills | 🚀 +200% |
| **团队总计** | **0** | **11** | **🚀 全面武装** |
